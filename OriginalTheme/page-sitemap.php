      ...
      <div class="sitemap__wrap">
        ...
        <ul class="sitemap__items">
          <li class="sitemap__item">
            ...
            <ul class="sitemap__sub-items">
              <li class="sitemap__sub-item"><a href="<?php echo esc_url(home_url('/information#tab01')); ?>">ライセンス講習</a>
              </li>
              <li class="sitemap__sub-item"><a href="<?php echo esc_url(home_url('/information#tab03')); ?>">体験ダイビング</a>
              </li>
              <li class="sitemap__sub-item"><a
